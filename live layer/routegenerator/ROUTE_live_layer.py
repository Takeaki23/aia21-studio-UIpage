...
def call(special_needs_visual:bool,special_needs_physical:bool,  public_image:float, origin = (48.19, 16.362), destination = (48.20, 16.364), ):
    ...
    urban_image_url = 'https://drive.google.com/file/d/1-jV3M-MaPq_EKyezH7-etr4a0y-616BY/view?usp=sharing'
    ...
    city_nodes = gpd.read_file(city_nodes_url)
    ...
    graph = ox.graph_from_gdfs(city_nodes, routes_edges )
